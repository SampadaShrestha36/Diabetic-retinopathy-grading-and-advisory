"""
Evaluates the trained EfficientNet-B0 model on a held-out test/validation
CSV and reports Accuracy, Quadratic Weighted Kappa (QWK), and AUC.

Usage:
    python test_efficientnet.py                              # defaults to combined_val_split.csv
    python test_efficientnet.py labels/ddr_labels.csv         # or point at any other labeled CSV
    python test_efficientnet.py --grad-cam-dir gradcam --grad-cam-limit 25
"""
...
def load_trained_model(checkpoint_path="best_model_stage2_efficientnet.pt", num_classes=5):
...
if __name__ == "__main__":
    ...
    checkpoint = "best_model_stage2_efficientnet.pt"
